...
{
public:
	void odom2world(Eigen::Vector3f target_pos, Eigen::Vector3f robot_pos, float &x, float &y);
...
void trans::odom2world(Eigen::Vector3f target_pos, Eigen::Vector3f robot_pos, float &x, float &y)
{
