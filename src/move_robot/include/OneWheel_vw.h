...
onewheel_vw::onewheel_vw(char *dev_name, int Baudrate):Move_Robot(dev_name, Baudrate)
{
  ...
  _pose_init_sub = node_.subscribe("initialpose", 1000, &onewheel_vw::init_pose_callback, this);//new add
...
void onewheel_vw::init_pose_callback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr &msg)//new add
{
...
std::cout<<"see 5  "<<std::endl;
	...
	{//==============change=============
      ...
      sendreceive.Package_OneWheel_encoder(0, 1.2, command);
	...
	void onewheel_vw::Calculate_odom()
	{
      ...
      float vx = Rev_odom_onewheel_v;
      float vy = 0;
      float vth = Rev_odom_onewheel_w;
      ...
      std::cout<<"===============local_x=========="<<x<<std::endl;
      std::cout<<"===============local_y=========="<<y<<std::endl;
