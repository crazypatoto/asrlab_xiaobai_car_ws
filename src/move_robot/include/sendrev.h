...
public:
    ...
    void RevProcess_OneWheel_encoder(std::vector<unsigned char> &rev_buf,float &Rev_V, float &Rev_W);
...
private:
    ...
    void RevProcess_Boling_onewheel(std::vector<unsigned char> &rev_buf,float &Rev_V, float &Rev_W);
...
void sendrev::RevProcess_Boling_onewheel(std::vector<unsigned char> &rev_buf,float &Rev_V, float &Rev_W)
{
    //static int count = 0;
...
void sendrev::RevProcess_OneWheel_encoder(std::vector<unsigned char> &rev_buf,float &Rev_V, float &Rev_W)
{
    switch(mode)
    {
        case Boling_onewheel:
            RevProcess_Boling_onewheel(rev_buf, Rev_V, Rev_W);
            break;
        default:
            break;
    }
